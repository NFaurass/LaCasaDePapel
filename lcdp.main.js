function doitnowb(eps, ses) {
  document.cookie = "episode=" + eps + "";
  document.cookie = "season=" + ses + "";
  document.cookie = "Image=https://raw.githack.com/NFaurass/LaCasaDePapel/master/S" + ses + "E" + eps + ".jpg";
  }
...
$("#LCDP1").append("<button class='bcard' id='ButtonCard-S" + season_val + "E" + episode_val + "' onclick='GoTo();doitnowb(" + episode_val + ", " + season_val + ")'><div class='card'><div class='episode closed'><div class='image'><a episode='" + episode_val + "' season='" + season_val + "' title='Money Heist: Episode " + episode_val + " -  Season " + season_val + "'><img alt='" + episoden_val + "' class='backdrop' src='https://raw.githack.com/NFaurass/LaCasaDePapel/master/S" + season_val + "E" + episode_val + ".jpg'/></a></div><div class='info'><div><div class='title'><div class='wrapper'><span class='episode_number'>" + episode_val + " - </span><h3><a episode='" + episode_val + "' season='" + season_val + "' title='Money Heist: Episode " + episode_val + " -  Season " + season_val + "'> " + episoden_val + "</a></h3></div></div><div class='overview'><p>" + Overview_val + "</p></div></div></div></div></div></button>");
                      });
                  });
